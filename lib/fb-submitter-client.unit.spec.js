...
test('When instantiating submitter client without a service secret', t => {
  testInstantiation(t, [serviceToken, serviceSlug, submitterUrl], 'ENOSERVICESECRET', 'No service secret passed to client')
})

// Set up a client to test the methods
const submitterClient = new FBSubmitterClient(serviceToken, serviceSlug, submitterUrl, serviceSecret)
