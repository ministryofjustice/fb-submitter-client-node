...
const {stub, useFakeTimers} = require('sinon') // eslint-disable-line no-unused-vars
...
test('When requesting submission status', async t => {
  ...
  t.deepEqual(callArgs[0], '/submission/:submissionId', 'it should call the correct url')
  t.deepEqual(callArgs[1], {submissionId: 'testSubmissionId'}, 'it should call the correct url')
...
test('When sending user instructions to submitter', async t => {
  ...
  t.deepEqual(callArgs[0], '/submission', 'it should call the correct url')
  t.deepEqual(callArgs[1], {}, 'it should call the correct url')
  t.deepEqual(callArgs[2], expectedJSON, 'it should post the correct data')
